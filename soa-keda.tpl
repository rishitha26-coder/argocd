...
spec:
  ...
  source:
    ...
    helm:
      valueFiles: 
        - ../../../{{ .Values.apps.repoDir }}/{{ .Values.apps.name }}/values-{{ .Values.apps.environment }}.yaml
        - ../../../{{ .Values.apps.valuesDir }}/environments/values-{{ .Values.apps.environment }}.yaml
        - ../../../{{ .Values.apps.valuesDir }}/{{ .Values.apps.name }}/values-{{ .Values.apps.environment }}.yaml
